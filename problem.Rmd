...
Produce a figure similar to Figure \@ref(fig:solow2) but for the case of 
a sudden decrease of $s$. Put the file in `figures`. In the body of the document, explain what happens 
to $k$ after the parameter change. 

The document must have all of the following.

* Correct graph
* Reasonable caption and 
* Reference to the Figure in the body at least once (If you use more than 
  one figure, all figures must be mentioned once.)
